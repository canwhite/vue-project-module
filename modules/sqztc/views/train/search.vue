<template>
	<div class="route search">
		...
		<div style="padding: 0 15px;position: relative;background-color: #F7F6FB;">
		...
		<div style="height: calc(100% - 118px);overflow: scroll;">
		 	<div v-show="!showHistory" v-cloak>
				<!--最新-->
...
<script>
	...
	export default {
	  ...
	  mounted(){
	  	if(localStorage.localHistory2){
	  		this.localHistory = JSON.parse(localStorage.localHistory2);
	  	}
	  },
	  activated(){
	  	let that = this;
	  ...
	  methods:{
	  	...
	  	restLocalHistory(){
	  		this.localHistory = [];
	  		localStorage.setItem('localHistory2',JSON.stringify(this.localHistory))
	  	},
...
<style>
	...
	.search .desc .data span i{padding: 0 5px 0 0px;font-size: 12px;}
